...
function Product({ product }: prouduct_Object) {
  ...
  return (
      ...
      <div className="flex relative flex-col gap-2 p-3 shadow_product w-3/4 lg:w-1/5 sm:w-40   h-96 justify-center cursor-pointer hover:-translate-y-1 duration-200 ease-in-out overflow-hidden   after_product border-1 border-sky-300 rounded-sm" onClick={() => router.push(`/productdetails/${id}`)}>
        <img
          src={image}
